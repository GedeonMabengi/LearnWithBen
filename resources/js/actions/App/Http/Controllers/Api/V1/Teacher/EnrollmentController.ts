...
/**
* @see \App\Http\Controllers\Api\V1\Teacher\EnrollmentController::markAttended
* @see app/Http/Controllers/Api/V1/Teacher/EnrollmentController.php:11
* @route '/api/v1/teacher/enrollments/{enrollment}/mark-attended'
*/
...
markAttended.definition = {
    methods: ["post"],
    url: '/api/v1/teacher/enrollments/{enrollment}/mark-attended',
...
/**
* @see \App\Http\Controllers\Api\V1\Teacher\EnrollmentController::markNoShow
* @see app/Http/Controllers/Api/V1/Teacher/EnrollmentController.php:19
* @route '/api/v1/teacher/enrollments/{enrollment}/mark-no-show'
*/
...
markNoShow.definition = {
    methods: ["post"],
    url: '/api/v1/teacher/enrollments/{enrollment}/mark-no-show',
} satisfies RouteDefinition<["post"]>
...
/**
* @see \App\Http\Controllers\Api\V1\Teacher\EnrollmentController::destroy
* @see app/Http/Controllers/Api/V1/Teacher/EnrollmentController.php:27
* @route '/api/v1/teacher/enrollments/{enrollment}'
*/
...
destroy.definition = {
    methods: ["delete"],
    url: '/api/v1/teacher/enrollments/{enrollment}',
