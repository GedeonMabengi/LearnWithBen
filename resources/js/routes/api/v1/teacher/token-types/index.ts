 ...
 */
export const tokens = (args: { token_type: number | { id: number } } | [token_type: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/api/v1/teacher/token-types/{token_type}/tokens'
 */
tokens.url = (args: { token_type: number | { id: number } } | [token_type: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { token_type: args }
    }
 ...
 * @route '/api/v1/teacher/token-types/{token_type}/tokens'
 */
tokens.get = (args: { token_type: number | { id: number } } | [token_type: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: tokens.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/api/v1/teacher/token-types/{token_type}/tokens'
 */
tokens.head = (args: { token_type: number | { id: number } } | [token_type: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: tokens.url(args, options),
    method: 'head',
})
 ...
 * @route '/api/v1/teacher/token-types/{token_type}/tokens'
 */
    const tokensForm = (args: { token_type: number | { id: number } } | [token_type: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/v1/teacher/token-types/{token_type}/tokens'
 */
        tokensForm.get = (args: { token_type: number | { id: number } } | [token_type: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: tokens.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/api/v1/teacher/token-types/{token_type}/tokens'
 */
        tokensForm.head = (args: { token_type: number | { id: number } } | [token_type: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
